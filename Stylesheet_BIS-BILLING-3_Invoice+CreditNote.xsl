...
******************************************************************************************************************
		...
		title= Peppol BIS Billing, Invoice and Credit Note transaction - Reference stylesheet
		...
		Derived from work by OIOUBL, Denmark. For more information, see www.sfti.se
